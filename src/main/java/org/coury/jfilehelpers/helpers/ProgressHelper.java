...
public class ProgressHelper {
  ...
  public static void notify(final ProgressChangeHandler handler, final ProgressMode mode,
    ...
    switch (mode) {
      ...
      case NotifyPercent:
        ...
        handler.handleProgressChange(new ProgressEventArgs(mode, (current * 100) / total, 100));
        break;
    }
  }
}
