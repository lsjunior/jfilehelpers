...
/**
 * @author Robert Eccardtt
 *
 * @param <T> the data record type
 */
public class BeforeWriteRecordEventArgs<T> extends WriteRecordEventArgs<T> {

  private boolean skipThisRecord = false;

  public BeforeWriteRecordEventArgs(final T record, final int lineNumber) {
