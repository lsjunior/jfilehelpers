...
public abstract class ReadRecordEventArgs {
  ...
  public ReadRecordEventArgs(final String recordLine, final int lineNumber) {
  ...
  public void setRecordLine(final String recordLine) {
    this.recordLine = recordLine;
    this.recordLineChanged = true;
  }

  public boolean getRecordLineChanged() {
    return this.recordLineChanged;
  }
