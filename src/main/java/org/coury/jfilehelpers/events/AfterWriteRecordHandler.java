...
public interface AfterWriteRecordHandler<T> {
  ...
  /**
   * The name of this method is very misleading because the record has not yet been written. It
   * gives the caller the opportunity to examine the proposed output and make any desired
   * modifications.
   */
